...
echo -e "${INFO}${YW}Application ports:${CL} ${BGN}Sonarr 8989, Radarr 7878, Lidarr 8686, Prowlarr 9696, Byparr 8191, FlareSolverr 8192, Seerr 5055, Bazarr 6767, Cleanuparr 11011${CL}"
